//
//  LoadingDisignerProductCell.swift
//  HayBase
//
...
final class LoadingDisignerProductCell: UICollectionViewCell {
    
    static let cellIdentifier = "LoadingDisignerProductCell"
    ...
    var shimmeringButton: ShimmeringView = {
        let view = ShimmeringView()
        view.translatesAutoresizingMaskIntoConstraints = false
        return view
    }()
...
extension LoadingDisignerProductCell {
    ...
    private func setupConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            shimmeringView.widthAnchor.constraint(equalToConstant: Layout.width * 0.5),
            shimmeringView.heightAnchor.constraint(equalTo: contentView.heightAnchor, multiplier: 0.7),
